...
# 打开网页
driver.get(settings.GOV_SHEN_LINKS['新疆维吾尔自治区农业农村厅'])
...
for key_class in Page:
    ...
    while True:
        ...
        for i in range(length):
            ...
            # 获取页面url                          /html/body/div[2]/div[2]/div[3]/div[20]/div[1]/div[1]/a
            url = driver.find_element(By.XPATH, f"/html/body/div[2]/div[2]/div[3]/div[20]/div[{i+1}]/div[1]/a").get_attribute("href")
            try:
            ...
            infomation = parse_article_html(response.text)

            # with open(f"./test/{infomation['title']}.html", "w", encoding="utf-8") as f:
            ...
            try:
                attachment_links[
                        driver.find_element(By.XPATH, f"/html/body/div[2]/div[2]/div[3]/div[20]/div[{i+1}]/div[2]/div/div/a").text
                    ] = driver.find_element(By.XPATH, f"/html/body/div[2]/div[2]/div[3]/div[20]/div[{i+1}]/div[2]/div/div/a").get_attribute("href")
            except:
                pass
        ...
        if parse_count <= count:
            ...
            k = len(driver.find_elements(By.XPATH, "/html/body/div[2]/div[2]/div[3]/div[24]/ul[2]/li"))
            while True:
                try:                                
                    driver.find_element(By.XPATH, f"/html/body/div[2]/div[2]/div[3]/div[24]/ul[2]/li[{k}]/a").click()
                    break
                except:
